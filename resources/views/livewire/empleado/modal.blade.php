<div>
    ...
    >
        ...
        <form class="grid grid-cols-1 gap-5">
            ...
            <div>
                <x-form.input wire:model.live="name" label="Nombre"/>
                <x-error-message> @error('name') {{ $message }} @enderror </x-error-message>
            </div>


            <div>
                <x-form.input type="password" wire:model.live="password" label="Contraseña" />
                <x-error-message> @error('password') {{ $message }} @enderror </x-error-message>
            </div>

            <div>
                <x-form.input type="date" wire:model.live="fecha_nacimiento" label="Fecha de nacimiento" />
            ...
            <div>
                <x-form.input type="email" wire:model.live="email" label="Correo Electronico" />
