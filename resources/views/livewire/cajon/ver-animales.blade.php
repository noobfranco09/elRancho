    ...
    >
        ...
        <div class="p-6 space-y-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="border-b-2 pb-4 flex items-center justify-between">
                <h3 class="text-2xl font-semibold text-gray-900">Animales asociados</h3>
            ...
            @else
                ...
                <h3 class="text-2xl font-semibold text-gray-900">No hay animales asociados a este cajon.</h3>
